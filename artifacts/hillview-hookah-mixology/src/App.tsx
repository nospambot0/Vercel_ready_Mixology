...
const HOME_INTRO_HOOKAH = 'data:image/jpeg;base64,';
...
function PosPage() {
  ...
  const sendReceiptEmail = async () => {
    ...
    if (!email.trim() || !email.includes('@')) { setEmailState('error'); setEmailError('Enter a valid email address.'); return; }
    setEmailState('sending'); setEmailError('');
    try {
  ...
  return (
    <main className="hv-shell hv-page-in pb-28"><div className="mx-auto max-w-5xl">
      <div className="mb-6 flex items-center justify-between gap-3"><div><SectionEyebrow>POINT OF SALE</SectionEyebrow><h1 className="hv-display text-5xl md:text-7xl">Mixology POS</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground">Create a bill, show a dynamic UPI QR with the exact amount, then manually confirm payment.</p></div><Link href="/manage" className="hidden min-h-10 items-center gap-2 rounded-xl border border-border px-4 text-xs font-bold hover:bg-muted md:inline-flex"><ArrowLeft size={15} /> Dashboard</Link></div>
      {!bill ? <section className="hv-surface rounded-[2rem] p-5 md:p-8"><div className="grid gap-5 md:grid-cols-2">
        <label className="block"><span className="mb-2 block text-xs font-bold uppercase tracking-wider text-muted-foreground">Amount</span><div className="flex items-center rounded-2xl border border-border bg-background/70 px-4"><span className="text-xl font-bold">₹</span><input value={amount} onChange={(e) => setAmount(e.target.value.replace(/[^0-9.]/g, ''))} inputMode="decimal" placeholder="0.00" className="min-h-14 w-full bg-transparent px-3 text-2xl font-bold outline-none" autoFocus /></div></label>
        <label className="block"><span className="mb-2 block text-xs font-bold uppercase tracking-wider text-muted-foreground">Remark / Table</span><input value={remark} onChange={(e) => setRemark(e.target.value)} placeholder="e.g. Table 4 / Hookah + coffee" className="min-h-14 w-full rounded-2xl border border-border bg-background/70 px-4 text-sm outline-none focus:border-secondary" /></label>
      </div><div className="mt-6 flex flex-col gap-3 rounded-2xl bg-muted/50 p-4 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between"><div><span className="font-bold text-foreground">UPI:</span> {PAYEE_UPI}<br />Amount will be locked into the QR.</div><button onClick={createBill} className="min-h-12 rounded-2xl bg-primary px-6 text-sm font-bold text-primary-foreground">Create Payment QR</button></div></section> :
      <div className="grid gap-5 lg:grid-cols-[1fr_1.1fr]"><section className="hv-surface rounded-[2rem] p-5 text-center md:p-8"><SectionEyebrow>SCAN TO PAY</SectionEyebrow><div className="mx-auto flex max-w-sm flex-col items-center"><div className="rounded-[1.75rem] bg-white p-4 shadow-xl"><img src={qrUrl} alt={`UPI payment QR for ₹${bill.amount.toFixed(2)}`} className="h-72 w-72 object-contain" /></div><p className="mt-5 text-4xl font-black">₹{bill.amount.toFixed(2)}</p><p className="mt-2 text-xs text-muted-foreground">{bill.remark || 'Mixology POS payment'}</p><p className="mt-4 rounded-full bg-muted px-3 py-1 font-mono text-[10px]">{bill.id}</p></div></section>
        ...
        {bill.status === 'PAID' && <section className="hv-surface pos-receipt rounded-[2rem] p-6 lg:col-span-2" data-testid="pos-acknowledgement">
          ...
          <div className="text-center"><p className="text-[10px] uppercase tracking-widest text-muted-foreground">Total Paid</p><p className="text-4xl font-black">₹{bill.amount.toFixed(2)}</p><p className="mt-4 text-[10px] text-muted-foreground">Thank you. Payment received.</p></div>
          <div className="mt-6 flex flex-col gap-3 border-t border-dashed border-foreground/40 pt-5 md:flex-row"><input type="email" value={email} onChange={(e) => { setEmail(e.target.value); setEmailState('idle'); setEmailError(''); }} placeholder="Customer email address" className="min-h-12 flex-1 rounded-xl border border-border bg-background px-4 text-sm outline-none" /><button onClick={sendReceiptEmail} disabled={emailState === 'sending'} className="min-h-12 rounded-xl bg-primary px-5 text-sm font-bold text-primary-foreground">{emailState === 'sending' ? 'Sending…' : emailState === 'sent' ? '✓ Sent' : 'Send Bill by Email'}</button></div>
          {emailError && <p className="mt-2 text-xs text-destructive">{emailError}</p>}{emailState === 'sent' && <p className="mt-2 text-xs text-secondary">Receipt sent successfully.</p>}
        </section>}
      </div>}
    </div></main>
  );
...
function DJRequestPage() {
  ...
  const addSong = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!extractYouTubeId(trimmed)) {
      setMessage('Please paste a valid YouTube song link.');
      return;
    }
    setAdding(true);
    try {
...
function DJPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    const setup = () => {
      if (cancelled || !(window as any).YT || playerRef.current) return;
  ...
  return (
    <main className="hv-shell hv-page-in pb-28">
      ...
      {showQr && <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/70 px-5 backdrop-blur-sm" role="dialog" aria-modal="true" onClick={() => setShowQr(false)}><div className="w-full max-w-sm rounded-[2rem] bg-background p-6 text-center shadow-2xl" onClick={(event) => event.stopPropagation()}><div className="flex items-center justify-between"><div className="text-left"><SectionEyebrow>SONG REQUESTS</SectionEyebrow><h2 className="hv-display text-3xl">Scan to request</h2></div><button type="button" onClick={() => setShowQr(false)} className="flex h-10 w-10 items-center justify-center rounded-xl text-muted-foreground hover:bg-muted"><X size={18} /></button></div><div className="mx-auto mt-5 w-fit rounded-2xl bg-white p-4"><img src={qrUrl} alt="QR code for DJ song requests" className="h-60 w-60" /></div><p className="mt-4 text-xs leading-5 text-muted-foreground">Customers can scan this code to add YouTube song links. They cannot control playback.</p><div className="mt-4 flex gap-2"><button type="button" onClick={() => void copyRequestLink()} className="flex min-h-11 flex-1 items-center justify-center gap-2 rounded-xl border border-border text-xs font-bold"><Copy size={14} /> {copied ? 'Copied' : 'Copy link'}</button><button type="button" onClick={() => setShowQr(false)} className="min-h-11 flex-1 rounded-xl bg-primary text-xs font-bold text-primary-foreground">Done</button></div></div></div>}
    </main>
  );
}
        ...
        {method === 'password' ? (
          ...
          step === 'email' ? (
            <form className="hv-surface rounded-[2rem] p-6 md:p-8" onSubmit={sendCode} data-testid="form-manage-login">
              ...
              <p className="mt-3 text-sm leading-6 text-muted-foreground">A one-time verification code will be sent to both authorized staff email accounts.</p>
              {error && <p className="mt-3 rounded-xl bg-destructive/10 px-3 py-2 text-xs font-semibold text-destructive" role="alert">{error}</p>}
              ...
              <p className="mt-4 text-center text-[10px] leading-5 text-muted-foreground">Both authorized staff accounts receive the same code.</p>
            </form>
          ) : (
            <form className="hv-surface rounded-[2rem] p-6 md:p-8" onSubmit={verifyCode} data-testid="form-manage-verify">
              ...
              <p className="mt-3 text-sm leading-6 text-muted-foreground">The same 6-digit OTP has been sent to both authorized staff email accounts. It expires in 10 minutes.</p>
              ...
              <button type="button" className="mt-3 min-h-10 w-full rounded-xl text-xs font-semibold text-muted-foreground hover:bg-muted" onClick={() => { setStep('email'); setCode(''); setError(''); }}>Send a new OTP</button>
            </form>
          )
        )}
      </div>
